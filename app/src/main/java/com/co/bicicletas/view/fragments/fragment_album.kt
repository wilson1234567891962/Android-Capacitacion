...
import com.co.bicicletas.view.activities.databinding.FragmentAlbumBinding
...
class fragment_album:Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = AlbumAdapter(this@fragment_album)
        // adapter instance is set to the recyclerview to inflate the items.
        mBinding!!.rvAlbumList.adapter = adapter
        var albums = listOf<Album>(Album("https://i.pinimg.com/564x/aa/5f/ed/aa5fed7fac61cc8f41d1e79db917a7cd.jpg","Rock"))
