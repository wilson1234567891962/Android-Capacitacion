package com.co.bicicletas.view.adapter
...
import com.co.bicicletas.view.activities.databinding.ItemAlbumLayoutBinding


class AlbumAdapter(private val fragment: Fragment) : RecyclerView.Adapter<AlbumAdapter.ViewHolder>() {
