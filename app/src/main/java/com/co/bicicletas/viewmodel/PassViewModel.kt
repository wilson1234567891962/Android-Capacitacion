...
class PassViewModel:ViewModel(){
    ...
    val PassResponse = MutableLiveData<BodyPassResponse>()
    val randomDishLoadingError = MutableLiveData<Boolean>()


    fun getPass(bodyPass: PassDTO) {
        ...
        compositeDisposable.add(
            ...
            backendApiService.doResetPass(bodyPass)
                 ...
                 */
                .subscribeWith(object : DisposableSingleObserver<BodyPassResponse>() {
                    override fun onSuccess(value: BodyPassResponse?) {
                        // Update the values with response in the success method.
                        loadRandomDish.value = false
                        PassResponse.value = value
