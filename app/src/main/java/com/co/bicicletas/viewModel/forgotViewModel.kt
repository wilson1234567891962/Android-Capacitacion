...
class forgotViewModel: ViewModel() {
    ...
    val forgotResponse = MutableLiveData<forgotPassRS>()
    val randomDishLoadingError = MutableLiveData<Boolean>()

    fun doForgot(body:forgotPassRQ) {
        ...
        compositeDisposable.add(
            ...
            backendApiService.doForgot(body)
                 ...
                 */
                .subscribeWith(object : DisposableSingleObserver<forgotPassRS>() {
                    override fun onSuccess(value: forgotPassRS?) {
